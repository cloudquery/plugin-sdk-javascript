...
class DiscoveryServer extends discovery1.cloudquery.discovery.v1
...
class PluginServer extends pluginV3.cloudquery.plugin.v3
  ...
  Init(
    call: grpc.ServerUnaryCall<
      pluginV3.cloudquery.plugin.v3.Init.Request,
      pluginV3.cloudquery.plugin.v3.Init.Response
    >,
...
export const getServer = () => {
  ...
  server.addService(
    pluginV3.cloudquery.plugin.v3.UnimplementedPluginService.definition,
    new PluginServer()
  );
  server.addService(
    discovery1.cloudquery.discovery.v1.UnimplementedDiscoveryService.definition,
    new DiscoveryServer()
  );
